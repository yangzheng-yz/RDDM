...
trainer = Trainer(
    ...
    convert_image_to="L",
    results_folder='/mnt/samsung/zheng_data/training_log/RDDM_deblurring_resonly',
    condition=condition,
...
if not trainer.accelerator.is_local_main_process:
    ...
    trainer.set_results_folder(
        '/mnt/samsung/zheng_data/training_log/RDDM_deblurring_resonly_newart_256/test_timestep_'+str(sampling_timesteps))
